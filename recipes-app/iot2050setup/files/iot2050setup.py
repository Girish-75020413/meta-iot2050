...
class PeripheralsMenu:
    ...
    def currentM2Select(self):
        ...
        if  manual_config:
            overlays_select = subprocess.check_output("fw_printenv name_overlays",shell=True).decode('utf-8')
    ...
    def m2AutoDetect(self):
        ...
        subprocess.call("fw_setenv name_overlays",shell=True )

    def m2_select_1(self):
        subprocess.call("fw_setenv m2_manual_config  y",shell=True)
        subprocess.call("fw_setenv name_overlays  ti/k3-am654-iot2050-bkey-usb3-ekey-pcie.dtbo",shell=True)

    def m2_select_2(self):
        subprocess.call("fw_setenv m2_manual_config  y",shell=True)
        subprocess.call("fw_setenv name_overlays  ti/k3-am654-iot2050-bkey-pcie-ekey-pcie.dtbo",shell=True)

    def m2_select_3(self):      
        subprocess.call("fw_setenv m2_manual_config  y",shell=True)
        subprocess.call("fw_setenv name_overlays  ti/k3-am654-iot2050-bkey-pciex2.dtbo",shell=True)
